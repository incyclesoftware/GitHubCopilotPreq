...
apt-get install -y build-essential linux-headers-generic libxmltooling-dev gdb gdbserver cmake libcppunit-dev libclang-dev  openjdk-21-jdk clang-tools llvm nasm cmake net-tools -y
